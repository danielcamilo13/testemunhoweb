...
class irmaos(models.Model):
    ...
    excecao_dia = models.CharField(max_length=60,blank=True,null=True,verbose_name='Excecao para dias ')
    grupo = models.CharField(max_length=3,blank=True,null=True,verbose_name='Grupo')
    ...
    dtModificado = models.DateField(verbose_name='Data de modificacao',default=timezone.now,null=True,blank=True)
...
class designacao(models.Model):
    ...
    p1 = models.CharField(verbose_name='Periodo 1',max_length=35)
    p1_1 = models.CharField(verbose_name='Periodo 1',max_length=35)
    p1_2 = models.CharField(verbose_name='Periodo 1',max_length=35)
    p2 = models.CharField(verbose_name='Periodo 2',max_length=35)
    p2_1 = models.CharField(verbose_name='Periodo 2',max_length=35)
    p3 = models.CharField(verbose_name='Periodo 3',max_length=35)
    p3_1= models.CharField(verbose_name='Periodo 3',max_length=35)
    p4= models.CharField(verbose_name='Periodo 4',max_length=35)
    p4_1= models.CharField(verbose_name='Periodo 4',max_length=35)
    p5= models.CharField(verbose_name='Periodo 5',max_length=35)
    p5_1= models.CharField(verbose_name='Periodo 5',max_length=35)
    def __str__(self):
